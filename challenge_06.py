...
#                                                               ;for locals
#   400c29:   48 89 7d a8             mov    %rdi,-0x58(%rbp)   ;first argument passed in (I think)
...
#                                                               ; maybe?
#   400c34:   00 00
#   400c36:   48 89 45 f8             mov    %rax,-0x8(%rbp)    ;hold onto the return value
#   400c3a:   31 c0                   xor    %eax,%eax          ; set eax to zero
...
#   400c89:   c7 45 b8 00 00 00 00    movl   $0x0,-0x48(%rbp)   ; store zero  -- sentinal maybe? used to loop over
#                                                                                an area from 0 <= 10 (11 times)

#   400c90:   eb 2b                   jmp    400cbd <create_decrypt_key+0x9c> ; Enter into a control loop **

#   400c92:   8b 45 b8                mov    -0x48(%rbp),%eax   ; put sentinal to %eax
...
#   400c9e:   8b 45 b8                mov    -0x48(%rbp),%eax   ; put sentinal back to eax
#   400ca1:   48 63 d0                movslq %eax,%rdx          ; store sentinal in a 64bit register
#   400ca4:   48 8b 45 a8             mov    -0x58(%rbp),%rax   ; first letter from passed in arg added to return var
#   400ca8:   48 01 c2                add    %rax,%rdx          ; add the sentinal value to the letter value?
...
#   400cb7:   88 02                   mov    %al,(%rdx)         ; move the low 8bits to rdx?

#   400cb9:   83 45 b8 01             addl   $0x1,-0x48(%rbp)   ; add one to the sentinal
...
#   400cc7:   48 83 c0 0b             add    $0xb,%rax          ; add 171 (?) to rax
